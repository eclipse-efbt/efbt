...
from .entry_points.import_sdd_domains_from_website import RunImportSDDDomainsFromWebsite
...
def run_import_sdd_domains(request):
    app_config = RunImportSDDDomainsFromWebsite('pybirdai', 'birds_nest')
    app_config.ready()
    return HttpResponse("Import SDD Domains from BIRD Website completed successfully.")
