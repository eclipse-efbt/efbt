...
class Context(object):
    ...
    def __init__(self):
        ldm_key_annotation_directive = ELAnnotationDirective(
            name="key", sourceURI="key"
        )
        ldm_dependency_annotation_directive = ELAnnotationDirective(
            name="dep", sourceURI="dep"
        )
        ...
        long_name_directive_ldm_entities = ELAnnotationDirective(
            name="long_name", sourceURI="long_name"
        )

        il_key_annotation_directive = ELAnnotationDirective(name="key", sourceURI="key")
        il_dependency_annotation_directive = ELAnnotationDirective(
            name="dep", sourceURI="dep"
        )
        ...
        il_code_annotation_directive = ELAnnotationDirective(
            name="code", sourceURI="code"
        )
        long_name_directive_il_entities = ELAnnotationDirective(
            name="long_name", sourceURI="long_name"
        )

        self.ldm_entities_package.annotationDirectives.append(
            ldm_key_annotation_directive
        )
        self.ldm_entities_package.annotationDirectives.append(
            ldm_dependency_annotation_directive
        )
        self.ldm_entities_package.annotationDirectives.append(
            ldm_entity_hierarchy_annotation_directive
        )
        self.ldm_entities_package.annotationDirectives.append(
            ldm_relationship_type_annotation_directive
        )
        self.ldm_entities_package.annotationDirectives.append(
            long_name_directive_ldm_entities
        )
        ...
        self.il_tables_package.annotationDirectives.append(
            il_dependency_annotation_directive
        )
        self.il_tables_package.annotationDirectives.append(
            il_entity_hierarchy_annotation_directive
        )
        self.il_tables_package.annotationDirectives.append(
            il_relationship_type_annotation_directive
        )
        self.il_tables_package.annotationDirectives.append(
            long_name_directive_il_entities
        )
