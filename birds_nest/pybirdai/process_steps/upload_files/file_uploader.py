...
class FileUploader:
        ...
        for file in request.FILES.getlist("eil_files"):
            try:
                ...
                uploaded_files.append(
                    {"name": file.name, "path": eil_directory, "size": file.size}
                )
    ...
    def upload_technical_export_files(self, sdd_context, request=None):
        ...
        uploaded_files = []
        resource_directory = sdd_context.file_directory
        technical_export_directory = os.path.join(
            resource_directory, "technical_export"
        )
    ...
    def upload_joins_configuration(self, sdd_context, request=None):
        ...
        uploaded_files = []
        resource_directory = sdd_context.file_directory
        joins_configuration_directory = os.path.join(
            resource_directory, "joins_configuration"
        )
