...
class JoinsMetaDataCreator:
                        ...
                        for table_part in table_parts:
                            ...
                            if table_part[0] == table:
                                for input_entity in input_entity_list:
                                    ...
                                    primary_cube = sdd_context.rol_cube_dictionary.get(
                                    ...
                                    if primary_cube:
                                        ...
                                        print(
                                            f"cube_link.primary_cube_id not found for {table}"
                                        )
    ...
    def add_field_to_field_lineage_to_rules_for_table_part(
        ...
        for output_item in sdd_context.rol_cube_structure_item_dictionary[
            ...
            if self.valid_operation(
                context, output_item, framework, category, report_template
            ):
                ...
                if input_columns:
                    for input_column in input_columns:
                        ...
                        if not (csil.primary_cube_variable_code.variable_id is None):
                            csil.cube_structure_item_link_id += f":{csil.primary_cube_variable_code.variable_id.variable_id}"
    ...
    def find_variables_with_same_domain_then_name(
        ...
        if target_domain and not (
            ...
            if input_entity:
                field_list = sdd_context.rol_cube_structure_item_dictionary[
                    input_entity.cube_structure_id
                ]
                for csi in field_list:
                    ...
                    if (
                        variable
                        and variable.domain_id.domain_id == target_domain.domain_id
                    ):
