...
echo. >> "%TEMP_PS_FILE%"
echo     # Grant permissions to read system tables >> "%TEMP_PS_FILE%"
echo     try { >> "%TEMP_PS_FILE%"
echo         Write-Host "Setting permissions to access system tables..." >> "%TEMP_PS_FILE%"
echo         $connection.Execute("GRANT SELECT ON MSysObjects TO Admin") >> "%TEMP_PS_FILE%"
echo         Write-Host "Permissions granted successfully" >> "%TEMP_PS_FILE%"
echo     } catch { >> "%TEMP_PS_FILE%"
echo         Write-Host "Warning: Could not grant permissions (may already exist): $($_.Exception.Message)" >> "%TEMP_PS_FILE%"
echo     } >> "%TEMP_PS_FILE%"
echo. >> "%TEMP_PS_FILE%"
