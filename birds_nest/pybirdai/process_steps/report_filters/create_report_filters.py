...
=======
        ...
        for cell_id, tuples in cell_to_variable_member_tuple_map.items():
            CreateReportFilters.process_cell(
                cell_id, tuples, sdd_context, context, framework, version
            )
>>>>>>> 6fc3086b (>efbt-1430 : Add Subdomain and VariableSet and MemberLink to SDD domain model + format)
...
=======
        ...
        if metric:
            CreateReportFilters.add_variable_to_rol_cube(
                context, sdd_context, report_rol_cube, metric
            )
        report_cell.metric = metric
        sdd_context.combination_dictionary[table_cell_combination_id] = report_cell
        if context.save_derived_sdd_items:
        ...
        CreateReportFilters.create_cube_to_combination(
            report_cell, report_rol_cube, sdd_context, context
        )
...
=======
    def create_filters(
        report_cell, tuples, relevant_mappings, report_rol_cube, sdd_context, context
    ):
>>>>>>> 6fc3086b (>efbt-1430 : Add Subdomain and VariableSet and MemberLink to SDD domain model + format)
        """
...
=======
                    CreateReportFilters.add_variable_to_rol_cube(
                        context, sdd_context, report_rol_cube, ref_variable
                    )
>>>>>>> 6fc3086b (>efbt-1430 : Add Subdomain and VariableSet and MemberLink to SDD domain model + format)
