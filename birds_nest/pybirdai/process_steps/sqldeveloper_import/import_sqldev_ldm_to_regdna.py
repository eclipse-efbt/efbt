...
class SQLDevLDMImport:
    ...
    def generate_etl(self, context):
        ...
        traverser.traverse(context,'BLNC_SHT_NN_BLNC_SHT_SCRTY_PSTN',False)
        traverser.traverse(context,'BLNC_SHT_NN_BLNC_SHT_SCRTY_PSTN',True)
        traverser.traverse(context,'LNG_SHRT_BLNC_SHT_RCGNS_PSTN',False)
        traverser.traverse(context,'LNG_SHRT_BLNC_SHT_RCGNS_PSTN',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTLFL_PSTN_ASSGNMNT',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTLFL_PSTN_ASSGNMNT',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMT_RSK_DT',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ASSGNMT_RSK_DT',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCT_ASSGNMNT_DRVD_DT',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCT_ASSGNMNT_DRVD_DT',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_DBT_SCRTY_PSTN_PRTFL_ACCNTNG_CLSSFCT_ASSGNMNT_DRVD_DT',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_DBT_SCRTY_PSTN_PRTFL_ACCNTNG_CLSSFCT_ASSGNMNT_DRVD_DT',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_EQUTY_OR_FND_SCRTY_PRDNTL_ACCNTNG_CLSSFCTN_ASSGNMNT_DRVD_DT',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_EQUTY_OR_FND_SCRTY_PRDNTL_ACCNTNG_CLSSFCTN_ASSGNMNT_DRVD_DT',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT_NTNL_GNRL_ACCPT_ACCNTNG_PRNCPL_NGAAP_FDCRY_ITM',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT_NTNL_GNRL_ACCPT_ACCNTNG_PRNCPL_NGAAP_FDCRY_ITM',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT_TKN_INT_PSSTN',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT_TKN_INT_PSSTN',True)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT_TKN_INT_PSSTN_DRVD_DT',False)
        traverser.traverse(context,'LNG_BLNC_SHT_RCGNSD_SCRTY_PSTN_PRDNTL_PRTFL_ACCNTNG_CLSSFCTN_ASSGNMNT_TKN_INT_PSSTN_DRVD_DT',True)
        traverser.traverse(context,'LNG_NN_BLNC_SHT_RCGNSD_SCRTY_PSTN_CLLTRL_RCV_ASSGNMNT',False)
        traverser.traverse(context,'LNG_NN_BLNC_SHT_RCGNSD_SCRTY_PSTN_CLLTRL_RCV_ASSGNMNT',True)
        traverser.traverse(context,'SHRT_BLNC_SHT_RCGNSD_PSTN_PRDNTL_PRTFL_ASSGNMNT',False)
        traverser.traverse(context,'SHRT_BLNC_SHT_RCGNSD_PSTN_PRDNTL_PRTFL_ASSGNMNT',True)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_DBT_SCRTY_PSTN_DRVD_DT',False)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_DBT_SCRTY_PSTN_DRVD_DT',True)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_DBT_SCRTY_PSTN',False)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_DBT_SCRTY_PSTN',True)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_PSTN_NTNL_GNRL_ACCPTTD_ACCNTNG_PRNCPLD_NGAAP_FDCRY_ITEM',False)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_PSTN_NTNL_GNRL_ACCPTTD_ACCNTNG_PRNCPLD_NGAAP_FDCRY_ITEM',True)
        traverser.traverse(context,'LNG_NN_BLNC_SHT_RCGNSD_PRTCTN_ARRNGMNT_RCVD_ASSGNMNT',False)
        traverser.traverse(context,'LNG_NN_BLNC_SHT_RCGNSD_PRTCTN_ARRNGMNT_RCVD_ASSGNMNT',True)
        traverser.traverse(context,'LNG_NN_BLNC_SHT_RCGNSD_SCRTY_PSTN_CLLTRL_RCV_ASSGNMNT_DRVD_DT',False)
        traverser.traverse(context,'LNG_NN_BLNC_SHT_RCGNSD_SCRTY_PSTN_CLLTRL_RCV_ASSGNMNT_DRVD_DT',True)
        traverser.traverse(context,'SHRT_BLNC_SHT_RCGNSD_SCRTY_PSTN_NTNL_GNRL_ACCPTD_PRNCPLS_FDCR_ITM',False)
        traverser.traverse(context,'SHRT_BLNC_SHT_RCGNSD_SCRTY_PSTN_NTNL_GNRL_ACCPTD_PRNCPLS_FDCR_ITM',True)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_DBT_EQUTY_OR_FND_PSTN_DRVD_DT',False)
        traverser.traverse(context,'NN_BLNC_SHT_RCGNSD_DBT_EQUTY_OR_FND_PSTN_DRVD_DT',True)
        traverser.traverse(context,'NN_BLNC_SFT_RCGNSD_SCRTY_PSTN_NTNL_GNRL_ACCPTD_ACCNTNG_PRNCPLS_FDCR_ITM',False)
        traverser.traverse(context,'NN_BLNC_SFT_RCGNSD_SCRTY_PSTN_NTNL_GNRL_ACCPTD_ACCNTNG_PRNCPLS_FDCR_ITM',True)  
